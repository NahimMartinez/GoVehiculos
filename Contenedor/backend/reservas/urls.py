...
from . import views_pago, views_reservas

urlpatterns = [
    path('reserva/', views_reservas.reservar_view, name='reserva_vehiculo'),
    ...
    path('reserva/crear/', views_reservas.crear_reserva_view, name='crear_reserva'),
    path('mis-reservas/', views_reservas.obtener_reservas_usuario_view, name='mis_reservas'),
    path('reserva/<int:reserva_id>/cancelar/', views_reservas.cancelar_reserva_view, name='cancelar_reserva'),
    path('reserva/<int:reserva_id>/detalle/', views_reservas.detalle_reserva_view, name='detalle_reserva'),
    # Checkout de pago
